...
<template>
    ...
    >
        ...
        <a-modal :width="700" :footer="null" v-model:open="chargeopen" title="充值" :afterClose="handchargeleOk">
            ...
            <a-card :bodyStyle="{ 'white-space': 'break-all' }" style="width: 340px">
                ...
                <a-card-meta
                    ...
                    :description="
                        ...
                        '\n 上传次数:' +
                        userinfo.chance.totalUploadChance
                    "
                >
                    <template #avatar>
        ...
        <div class="bottom-0 w-full p-4 bg-gray-100" style="position: absolute">
            ...
            <div class="flex flex-row" style="align-items: center">
                ...
                >
                    <a-config-provider :theme="{ token: { colorPrimary: ' rgb(64, 70, 79)' } }">
                        <a-cascader
                            ...
                            @change="modelOnChange"
                        >
                            <GlobalOutlined :style="{ fontSize: '20px', padding: '6px 0px' }" />
                        </a-cascader>
                    </a-config-provider>
                </div>
                <a-button
                ...
                >
                    ...
                    <a-icon :style="{ fontSize: '20px', display: 'flex', flexDirection: 'row', alineItems: 'center' }">
                        <svg
                            t="1706857678840"
                            class="icon"
                            viewBox="0 0 1024 1024"
