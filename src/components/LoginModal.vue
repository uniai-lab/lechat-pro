...
<template>
    ...
    >
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button
                                ...
                                :class="loginflag ? '' : 'bg-gray-600 text-mini'"
                                type="button"
                            >
                                {{ getCodetitle }}
                            </button>
        ...
        <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="请输入密码">
                    ...
                    <div
                        class="flex justify-center items-center mt-9 mb-0"
                        :data-id="type"
                        @click="changetype('password')"
                    >
                        <div class="flex justify-center items-center flex-col">
                            <div
                                class="flex justify-center items-center bg-gray-100 p-2 rounded-full hover:bg-gray-200"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                            ...
                            <div class="flex mt-2 text-xs justify-center items-center text-gray-700">密码登录</div>
                        </div>
                    </div>
                </form>
                ...
                <form v-if="type == 'password'" class="w-max" style="width: 310px">
                    ...
                    >
                        <div class="flex justify-center items-center flex-col">
                            ...
                            <div class="flex mt-2 text-xs justify-center items-center text-gray-700">手机验证码</div>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="mb-2">
                        ...
                        >
                            <Flex gap="middle" wrap="wrap">
                                ...
                                <QRCode
                                    v-if="codesstatus != 'active'"
                                    size="220"
                                    :value="111231312312321312"
                                    :status="codesstatus"
                                    :onRefresh="codeRefresh"
                                />
                                <img
                                    v-if="codesstatus == 'active'"
                                    style="height: 200px; filter: grayscale(1) brightness(0.6) contrast(500%)"
                                    :src="codevalue"
                                    @click="codeRefresh"
                                />
                        ...
                        <label
                            ...
                            class="w-full text-gray-600 mb-2 flex items-center justify-center"
            ...
            timer = setInterval(async () => {
                ...
                try {
                    const res = await http(
                        `verify-qr-code?token=${qrcodetocken.value}`,
                        { token: qrcodetocken.value },
                        'GET'
                    )
                    const qes = await res.json()
                    // console.log('持续监听');
